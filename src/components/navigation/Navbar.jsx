        ...
        <div className="flex items-center gap-4">
          <div className="main">
            <div className="element-wrapper">
              ...
              <a className="element navlink font-Inter font-medium text-base text-white" href="./index.html">Home</a>
              <a className="element font-Inter font-medium text-base text-white" href="./pages/about.html">About</a>
              <a className="element font-Inter font-medium text-base text-white" href="./pages/service.html">Service</a>
              <a className="element font-Inter font-medium text-base text-white" href="./pages/blog.html">Blog</a>
              <a className="element font-Inter font-medium text-base text-white" href="./pages/contact-us.html">Contact</a>
            </div>
          </div>

          <button id="addClassBtn" className="bg-[#C9C9C933]/20 p-[10px] rounded">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M3.75 6H20.25" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M3.75 12H20.25" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M3.75 18H13.5" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </button>
          <button id="removeActiveBtn" className="bg-[#C9C9C933]/20 p-[10px] rounded hidden">
  ...
  <header className="py-2 md:py-4 w-full fixed left-0 top-0 z-40  backdrop md:hidden">
    <div className="container">
      <div className="flex items-center justify-between">
        ...
        <div
          className="mobile-overlay transition-all ease-linear duration-500 h-screen w-full bg-black/30 fixed inset-0 opacity-0 invisible z-40 md:hidden">
        </div>

        <div>
          <button onClick={handleMenuToggle} className="menu-toggle bg-[#C9C9C933]/20 p-2 rounded">
          ...
          {/* <!-- Mobile menu  --> */}
        {
            isMenuOpen && (
                <div
                className="mobile-menu transition-all ease-linear duration-500 h-screen lg:h-auto w-[241px] lg:w-auto bg-csk lg:bg-transparent fixed z-50 lg:static top-0 p-4 lg:p-0 overflow-y-auto md:overscroll-none shadow lg:shadow-none">
                <button
                onClick={handleCloseMenu}
                  className="close-menu bg-[#283A3D] p-1 rounded flex items-center justify-center absolute right-3 mt-[14px] mr-2">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M6 5.99976L17.6673 17.667" stroke="white" strokeWidth="2" strokeLinecap="round"
                      strokeLinejoin="round" />
                    <path d="M6 18.0002L17.6673 6.33298" stroke="white" strokeWidth="2" strokeLinecap="round"
                      strokeLinejoin="round" />
                  </svg>
                </button>
    
                <ul className="flex flex-col items-center pt-[150px] gap-6">
                  <li className="relative"> <a href="./index.html"
                      className="font-Inter font-medium text-base text-light_gray p-[10px] activePage">Home</a></li>
                  <li> <a href="./pages/about.html"
                      className="font-Inter font-medium text-base text-light_gray p-[10px]">About</a></li>
                  <li> <a href="./pages/service.html"
                      className="font-Inter font-medium text-base text-light_gray p-[10px]">Service</a></li>
                  <li> <a href="./pages/blog.html"
                      className="font-Inter font-medium text-base text-light_gray p-[10px]">Blog</a></li>
                  <li> <a href="./pages/blog.html"
                      className="font-Inter font-medium text-base text-light_gray p-[10px]">Contact</a></li>
                </ul>
                ...
                <div className="flex flex-col mt-[290px]">
                  ...
                  <p className="font-Inter text-xs text-light_gray opacity-60 text-center pt-4">Copyright 2023,all rights
                    reserved.</p>
                </div>
